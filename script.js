...
nextBtn.addEventListener("click", () => {
  ...
  if (index < messages.length) {
    ...
    messageEl.textContent = "Nisa, Mau gak kamu jadi pacar mas? 💕";
    ...
    yesBtn.onclick = () => {
      messageEl.innerHTML = "🎉 Yeay! Sekarang kamu resmi jadi pacar mas  <br> (Hadiah Real Lifenya nyusul yaww) 😍";
      btnContainer.remove();
